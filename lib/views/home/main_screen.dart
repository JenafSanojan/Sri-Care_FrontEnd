  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        // For web, wider screen (e.g., > 600 pixels)
        // For Android, narrower screen (e.g., <= 600 pixels)
        if (constraints.maxWidth > 600) {
          // Web version: Permanent left sidebar
          return Scaffold(
            appBar: AppBar(
              title: Text(
                widget.title,
              ...
              actions: [
                // Add any actions you want in the AppBar, e.g., search, notifications, profile, logout
                IconButton(
                ...
                IconButton(
                  icon: Icon(Icons.account_circle, color: darkGreen),
                  onPressed: () {
          ...
          // Android version: Bottom navigation bar
          return Scaffold(
            appBar: AppBar(
              title: Text(
                widget.title,
